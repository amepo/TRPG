...
const ANCESTRIES = [
  {
    ...
    look: 'この地方の基準がこれ。何も言われないということが、そのまま特徴になっている。',
    share: '十人に七人',
  ...
  },
  {
    ...
    share: '十人に一人',
    look: '背が高く痩せていて、耳が長い。ひと目で分かるが、**歳が顔から読めない**。'
      + '二十歳にも二百歳にも見えるので、村人は年上として扱うか年下として扱うかを毎回迷う。',
  ...
  },
  {
    ...
    share: '十人に一人',
    look: '背が低く肩が広い。髭は男女ともに蓄える。手が体の割に大きく、'
      + '握手をすると相手がそれに気づく。',
  ...
  },
  {
    ...
    share: '十人に一人',
    look: '人間の子どもほどの背丈。ただし顔は大人のものなので、遠目で取り違えた者が近づいて驚く。'
      + '足の裏が硬く、履物を履かない者が多い。',
  ...
  },
  {
    ...
    /* 竜鱗が特性として実装されている以上、鱗は見えていなければ嘘になる。 */
    share: '村ひとつに一人いるかいないか',
    look: '**見れば分かる**。人間ほどの背丈だが、肌に鱗があり、瞳孔が縦に割れている。'
      + '体温が高いので冬に息が濃く白い。隠しようがないので、**村に入るときはたいてい一度止められる**。'
      + '止めた側も何を確かめたいのか分かっていない——確かめる手立てが無いからだ。',
  ...
  },
  {
    ...
    /* 闇の知恵（暗がりで見える）が実装されている。目が光を捉えるなら、
       灯りを向けたときに光って見える——灯りが境界であるこの地方では、それが効く。 */
    share: '村ひとつに一人いるかいないか（数えられないので、実際はもう少し多い）',
    look: '**昼は人間に見える**。徴は個体差が大きく、角が生える者もいれば、'
      + '爪が黒いだけの者もいる。共通しているのは目で、**暗がりで灯りを向けると光る**。'
      + '灯りの内と外で人を分けるこの地方では、これがいちばん困る特徴になる。'
      + '隠して暮らす者は多い。隠していたと知られたときのほうが、話がこじれる。',
...
const ITEMS = {
  ...
  emberFang: {
    ...
    desc: '竜の牙とされるものを柄に据えた短槍。売り手はそう言った。命中するたびに 1d6 の火が乗る。'
...
const LORE = {
  primer: [
    ...
    '**竜血と魔筋は、村によって入ったり入らなかったりする**——線をどこに引くかは、' +
    'その村がこれまでに何を見てきたかで決まる。' +
  ...
  truths: [
    ...
    /* 「種族比ってどんなもんかな？」から。人間が多くて、エルフ・ドワーフ・
       ハーフリングが同率、竜血と魔筋がレア——という読みで合っている。
       数字にしておくと、村を描くときに「何人に一人か」で考えられる。 */
    {
      title: '十人のうち七人は人間',
      text: '街道沿いの村を十人ぶん数えると、**七人が人間、あと三人をエルフ・ドワーフ・ハーフリングで分ける**。'
        + 'ドワーフは坑道のある土地に、ハーフリングは畑のある土地に寄るので、村ごとの偏りは大きい。'
        + '**竜血と魔筋は、村ひとつに一人いるかいないか**。'
        + 'だからどちらも「見たことはある」ではなく「話に聞いたことがある」側に置かれている——'
        + '一度も会わずに一生を終える村人のほうが多い。'
        + 'ただし魔筋は数えられていない。**昼は人間に見えるので、名簿の上では人間として数えられている**。'
        + 'この地方の「魔筋は珍しい」は、たぶん少しだけ嘘だ。',
    },
    /* 「竜血と魔筋の見た目は人間と同じ？」から。導入の「人」の一覧に
       この二つが入っていなかったのを、抜けではなく線引きとして決めた。 */
    {
      title: '「人」の線は村が引く',
      text: 'エルフもドワーフもハーフリングも、この地方では当たり前に「人」に数えられる。'
        + '**竜血と魔筋はそこが揺れる**。竜血は鱗と縦の瞳孔で見れば分かり、'
        + '魔筋は昼のあいだ人間に見えるが、暗がりで灯りを向けると目が光る。'
        + '灯りの内と外で人を分けてきた土地なので、**暗がりで光るもの**はそれだけで話が別になる。'
        + 'どちらを泊めるか、井戸を使わせるか、鐘楼に入れるかは村ごとに違い、'
        + '書かれた決まりはない。**訊くまで分からず、訊いた時点で角が立つ**。',
    },
    /* 「竜ってメジャーな存在？　でかい牙を見せられたら竜の牙だと思う？」から。
       敵の一覧に竜は一体もおらず（最大がオーガ）、不死は4体いる。
       つまりこの地方の「恐ろしいもの」の語彙は、すでに不死で出来ている。
       竜血が playable なのに竜が出てこないのは矛盾ではなく、そのまま設定になる。 */
    {
      title: '竜は話の中にいる',
      text: 'この地方に竜は出ない。正確には**出た記録が無い**——街道守備隊の手引きにも、'
        + '商隊組合の危険物一覧にも、竜の項目が無い。要らなかったからだ。'
        + 'だから村人が肉食獣より大きい牙を見せられても、思い浮かべるのは竜ではない。'
        + 'まず**熊**、次に**「狼でないもの」**、そのどちらでもなければ**墓から出たなにか**。'
        + 'この地方の恐ろしいものの語彙は、不死のもので出来ている。'
        + '「竜の牙だ」と言われて信じるのは売り手がそう言ったときだけで、'
        + '確かめられる者はほとんどいない——鑑定には魔法学が要り、学院は三つしかなく、どれも遠い。'
        + 'なお**竜血の者は普通に歩いている**。息に火が混じるのは事実だが、'
        + 'それが竜から来ている証拠は誰も持っていない。「竜血」は本人たちの自称ではなく、村がつけた呼び名だ。',
    },
  ...
  tables: [
    {
      ...
      entries: [
        ...
        '「竜の牙」を売る行商人が来ている。三本目だ。同じ竜から採れたことになっている。',
        '北の森で大きな骨が出た。牛だろう、と村長は言った。牛にしては歯が多い。',
      ],
    },
    {
