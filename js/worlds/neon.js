...
const LORE = {
  ...
  factions: [
    ...
    {
      name: '皇極重工',
      blurb: 'メリディアンと並ぶもう一つの柱。重工と兵器と、そして送電。'
  ...
  truths: [
    ...
    },
    {
      ...
      text: '上層の一部は、生活のほとんどを仮想空間で送っているらしい。'
        + '肉体を完全に手放した者がいる、という話まで来ると、下層では都市伝説の扱いになる。'
