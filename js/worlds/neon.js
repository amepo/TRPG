...
const ORIGINS = [
  {
    ...
    look: '肌が綺麗で、歯が揃っている。下層ではそれだけで浮く。'
      + '雨に濡れたときの動き方で、傘を持ったことのある人生だと分かる。',
  ...
  },
  {
    ...
    look: '安い改造の縫い目が首や手首に残っている。'
      + '酸性雨の跡が服にも肌にもあって、上層では入口で止められる理由になる。',
  ...
  },
  {
    ...
    look: '陽に灼けている。街には陽が届かないので、それだけで外の人間だと分かる。'
      + '氏族の印を彫るか焼くかしていて、隠す気がない。',
  ...
  },
  {
    ...
    look: '姿勢と、部屋に入るときに出口を見る癖。軍の改造は外から見えない場所に入れる規則だが、'
      + '抜いた跡は残る。同じ経歴の人間には一目で分かる。',
  ...
  },
  {
    ...
    look: '外見は誰とも変わらない。喋ると分かる——言い回しが二段階丁寧で、'
      + 'それが下層では距離として伝わる。',
  ...
  },
  {
    ...
    look: '**どこまで作りものかは人による**。皮膚だけ人のものを張っている者は、'
      + '触れられるまで気づかれない。逆に隠す気のない者は、関節を見せて歩く。'
      + '共通しているのは体温で、冬に息が白くならない。',
